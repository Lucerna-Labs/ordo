...
pub struct AssistantService {
    pub(crate) store: Arc<Mutex<AssistantStore>>,
    pub(crate) facts: FactStore,
    pub(crate) knowledge: KnowledgeStore,
    pub(crate) credentials: CloudCredentialTask,
    pub(crate) http: CloudHttp,
    ...
    pub(crate) failover_chain: Vec<String>,
    pub(crate) tools: Option<ToolGateway>,
    ...
    pub(crate) review: Option<ordo_review::ReviewService>,
    ...
    pub(crate) memory_log: Option<ordo_memory_log::MemoryLogService>,
    ...
    pub(crate) session_taint: Arc<Mutex<HashMap<Uuid, Vec<ordo_protocol::Taint>>>>,
    ...
    pub(crate) session_isolation: Arc<Mutex<HashMap<Uuid, SubagentIsolation>>>,
    ...
    pub(crate) modes: Option<ordo_modes::ModeRegistry>,
...
pub(crate) struct SubagentIsolation {
    ...
    pub(crate) allowed_lanes: Option<Vec<String>>,
...
impl AssistantService {
    ...
    pub(crate) fn resolve_mode_for_session(&self, session_id: Uuid) -> Option<ordo_modes::ModeManifest> {
